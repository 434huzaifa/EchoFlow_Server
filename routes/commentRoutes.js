...
import { createCommentSchema, updateCommentSchema } from '../middleware/validation.js';
import {
  createComment,
  getComments,
  getCommentById,
...
router.put('/:id', authMiddleware, validateRequest(updateCommentSchema), asyncHandler(updateComment));
